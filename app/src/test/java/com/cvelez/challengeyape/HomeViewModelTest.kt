...
import com.cvelez.challengeyape.domain.use_case.GetListRecipeUseCase
import com.cvelez.challengeyape.domain.use_case.GetRecipesUseCase
import com.cvelez.challengeyape.domain.use_case.GetSearchRecipes
import com.cvelez.challengeyape.ui.home.HomeEvent
import com.cvelez.challengeyape.ui.home.HomeState
import com.cvelez.challengeyape.ui.home.HomeViewModel
...
class HomeViewModelTest {
    ...
    fun `searchRecipes handles Success`() = runBlocking {
        val mockRecipes = com.cvelez.challengeyape.domain.model.info.Info(1)
        ...
        val updatedState = viewModel.state
        Assert.assertEquals(false, updatedState.isLoading)
        Assert.assertEquals(mockRecipes, com.cvelez.challengeyape.domain.model.info.Info(updatedState.page)
        )
    }
